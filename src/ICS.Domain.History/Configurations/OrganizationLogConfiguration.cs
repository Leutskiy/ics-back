...
{
    public sealed class OrganizationLogConfiguration : EntityTypeConfiguration<OrganizationLog>
    {
        public string TableName => "OrganizationLogs";

        public OrganizationLogConfiguration(string schemaName)
        {
